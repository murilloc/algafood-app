...
public class EstatisticasController {
    ...
    public ResponseEntity<byte[]> consultarVendasDiariasPdf(
        ...
        byte[] pdfBytes = vendaReportService.emitirVendasDiarias(filtro, timeOffset);

        var headers = new HttpHeaders();
        headers.add(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=vendas-diarias.pdf"); // para download
