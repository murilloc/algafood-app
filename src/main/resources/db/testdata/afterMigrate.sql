...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (1, 'Thai Gourmet', 10, 1, utc_timestamp, utc_timestamp, 1,1, 1, '38400-999', 'Rua João Pinheiro', '1000', 'Centro');
...
insert into permissao (id, nome, descricao) values (3, 'CONSULTAR_RESTAURANTE', 'Permite editar restaurantes');
insert into permissao (id, nome, descricao) values (4, 'CADASTRAR_RESTAURANTE', 'Permite cadastrar um novo restaurantes');
insert into permissao (id, nome, descricao) values (5, 'DELETAR_RESTAURANTE', 'Permite deletar um restaurantes');
insert into permissao (id, nome, descricao) values (6, 'ABRIR_RESTAURANTE', 'Permite abrir um restaurantes');
insert into permissao (id, nome, descricao) values (7, 'CONSULTAR_PRODUTOS', 'Permite consultar todos os produtos');
...
insert into grupo (nome) values('Gerente'), ('Vendedor'), ('Secretária'), ('Cadastrador'), ('Público');
...
insert into item_pedido (id,data_criacao, pedido_id, produto_id, quantidade, preco_unitario, preco_total, observacao)
values (4,utc_timestamp, 3, 2, 1, 110, 110, null);
...
insert into item_pedido (id,data_criacao, pedido_id, produto_id, quantidade, preco_unitario, preco_total, observacao)
values (5,utc_timestamp, 4, 3, 2, 87.2, 174.4, null);
...
insert into item_pedido (id,data_criacao, pedido_id, produto_id, quantidade, preco_unitario, preco_total, observacao)
values (6,utc_timestamp, 5, 3, 1, 87.2, 87.2, null);


insert into pedido (id,codigo ,restaurante_id, cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                    status_pedido, data_criacao, subtotal, taxa_frete, valor_total)
values (null,'794f03c7-b9a5-11ea-84f4-0242ac120002', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
        'CRIADO', utc_timestamp, 298.90, 10, 308.90);

insert into item_pedido (id, data_criacao, pedido_id, produto_id, quantidade, preco_unitario, preco_total, observacao)
values (null,utc_timestamp, 1, 1, 1, 78.9, 78.9, null);
...
insert into pedido (id, codigo, restaurante_id, cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                    status_pedido, data_criacao, subtotal, taxa_frete, valor_total)
values (null,'6ea7f97f-b9a5-11ea-84f4-0242ac120002', 4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
        'CRIADO', utc_timestamp, 79, 0, 79);

insert into item_pedido (id, data_criacao,pedido_id, produto_id, quantidade, preco_unitario, preco_total, observacao)
values (null,utc_timestamp, 2, 6, 1, 79, 79, 'Ao ponto');