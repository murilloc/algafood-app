...
create table item_pedido (id bigint not null auto_increment, data_atualizacao datetime not null, data_criacao datetime not null, observacao varchar(255), preco_total decimal(19,2) not null, preco_unicario decimal(19,2) not null, quantidade integer not null, pedido_id bigint, produto_id bigint, primary key (id)) engine=InnoDB
create table pedido (id bigint not null auto_increment, data_atualizacao datetime(6), data_cancelamento datetime(6), data_confirmacao datetime(6), data_criacao datetime(6) not null, data_entrega datetime(6), endereco_bairro varchar(255), endereco_cep varchar(255), endereco_complemento varchar(255), endereco_logradouro varchar(255), endereco_numero varchar(255), status_pedido varchar(255) not null, subtotal decimal(19,2) not null, valor_total decimal(19,2) not null, endereco_cidade_id bigint, restaurante_id bigint not null, usuario_id bigint not null, primary key (id)) engine=InnoDB
...
create table usuario (id bigint not null auto_increment, email varchar(255), senha varchar(255), primary key (id)) engine=InnoDB
